...
import { getViewInvestmentRp } from '../Service';
...
const ViewInvestmentReport = () => {
    ...
    const fetchReportData = async () => {
        try {
            const reportData = await getViewInvestmentRp(selectedYear); // Call the service function
...
export default ViewInvestmentReport;
