...
import { getViewSparepartRp } from '../Service';
...
const ViewSpareReport = () => {
    ...
    const fetchReportData = async () => {
        try {
            const reportData = await getViewSparepartRp(selectedYear); // Call the service function
...
export default ViewSpareReport;
